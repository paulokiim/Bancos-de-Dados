  ...
  return (
    <div>
      <div className={header}>
        ...
        <Fragment>
          <CompoundButton onClick={openPurchase}>Visualizar Compras</CompoundButton>
        </Fragment>
      </div>
      ...
      <SearchPurchaseComponent showPurchaseModal={showPurchaseModal} setShowPurchaseModal={setShowPurchaseModal}/>
    </div>
  )
}
